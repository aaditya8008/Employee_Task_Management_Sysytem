...
<body>
  ...
  <div class="button-container">
    <a class="dashboard-button" href="admin_dashboard.php" type="button" id="dashboard_button">Dashboard</a>
    <a class="dashboard-button"  type="button" id="create_task">Create task</a>
    <a class="dashboard-button"  type="button" id="manage_task">Manage task</a>
    <a class="dashboard-button"  type="button" id="view_leave">Leave applications</a>
